...
****[_**Steam**_](broken-reference) _**-**_ [_**PhysKit**_](assets/physkit/) _**-**_ [_**User eXperience**_](assets/ux/) _**-**_ [_**Design**_](broken-reference) _**-**_ [_**Development**_](broken-reference) _**-**_ [_**Marketing**_](broken-reference)_****_
...
{% hint style="success" %}
This resource is available for free to any who have use of it and is supported wholly by the [Heathen GitHub Sponsor](https://github.com/sponsors/heathen-engineering) program, you can learn more about how you can help us Do More in our article on "[Becoming a Sponsor](become-a-sponsor.md)".
{% endhint %}

## Getting Started

Not sure where to start? ... [try the beginning](broken-reference)!

Our getting started guide will help you break into our general guides which them selves cover everything from the core [fundamentals](broken-reference) to more advanced topics in [design](broken-reference), [development](broken-reference), [testing](broken-reference) and more.

Looking to make a living as an Indie Game Dev? be sure to read over our [Indie Check List](broken-reference) and when your ready join our [Discord community](https://discord.gg/6X3xrRc).
