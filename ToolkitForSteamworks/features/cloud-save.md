---
description: aka Steam Remote Storage
---
...
For more information on Steam's Auto Cloud and its configuration [read this article](https://partner.steamgames.com/doc/features/cloud#steam_auto-cloud).
...
It is a drop box-like file sync system that synchronizes files written to the local disk to Steam's remote storage (aka cloud). It does work in offline mode and handles syncing data between all devices the user plays on.
...
<img src="../.gitbook/assets/image (279).png" alt="Assume Test Save Game is my Blueprint derived from Steam Remote Storage Save Game" data-size="original">
...
<figure><img src="../.gitbook/assets/image (284).png" alt=""><figcaption><p>Synchronious File Read</p></figcaption></figure>

<figure><img src="../.gitbook/assets/image (285).png" alt=""><figcaption><p>Asynchronious File Read</p></figcaption></figure>
{% endtab %}
