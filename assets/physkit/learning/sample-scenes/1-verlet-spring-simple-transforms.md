...
3. Setting up Verlet Spring componenets with [referenced configuraiton](../../objects/verlet-hierarchy-settings.md) (the grass)
...
The tower object's pivot child implaments the Verlet Spring componenet and a Constant Angular Velocity component. The Verlet Spring has a single configured hierarchy configured with a constant configuration ... this means the configuration is defined as part of the game obejct its self.

The tower Verlet Spring rotates around whiping across the meshes in its path demonstrating a rope or chain simulation as well as complex collision detection.
