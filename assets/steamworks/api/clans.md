...
{% hint style="info" %}
Its generally easier to use the [Clan Chat Director](../for-unity-game-engine/components/clan-chat-director.md) than to manually listen on this event.
{% endhint %}
...
You generally do not need to call this if your using the [EventChatMessageReceievd ](clans.md#eventchatmessagerecieved)or the [ClanChatDirector](../for-unity-game-engine/components/clan-chat-director.md).
