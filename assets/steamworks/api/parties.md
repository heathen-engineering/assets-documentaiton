...
You can attach metadata to a beacon similar to the metadata concept with [Steam Lobby](../troubleshooting-and-how-to-guides/multiplayer/matchmaking-tools.md) based matchmaking. You can use the party system along side other forms of matchmaking manually updating the available "slots" a beacon is advertising.
