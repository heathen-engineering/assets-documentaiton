...
Lets you connect an [InputAction](../objects/input-action.md) to a method that takes an [InputActionUpdate ](../objects/input-action-update.md)value as a parameter in the Unity Editor Inspector similar to the behaviour with a UI Button Click event.
