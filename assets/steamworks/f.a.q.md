...
1. Does not embed a copy of Steamworks.NET in its source code. Steamworks.NET should always be installed fresh from GitHub preferably via the Unity Package Manager as described on our [installation page](for-unity-game-engine/installation/prerequisites.md#steamworks.net).
...
Yes: You can find more information in the [Networking Integrations](for-unity-game-engine/installation/networking-integrations.md) article.
