...
Gets the [Lobby Member](../../objects/lobby-member-data.md) data for the current lobby owner.
...
Gets the local user's [Lobby Member](../../objects/lobby-member-data.md) data for the current lobby.
