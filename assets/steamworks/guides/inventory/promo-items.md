...
With an item defined you can simply call [Add Promo Item](../../api/inventory.md#addpromoitem), This can either be done from the [Inventory API](../../api/inventory.md#add-promo-item) or from the [Item Definition](../../for-unity-game-engine/scriptable-objects/item-definition.md#add-promo-item) object its self.
