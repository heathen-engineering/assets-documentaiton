...
This is a scriptable object used to define the leaderboard in Unity and used within Unity to query the board and access its information. Read more in the [Leaderboard Object](../../for-unity-game-engine/scriptable-objects/leaderboard-object.md) document.
...
You can learn more about the [Leaderboard Manager](../../for-unity-game-engine/components/leaderboard-manager.md) in its documentation article and by reviewing the [4 Leaderboards](../../for-unity-game-engine/samples/leaderboards.md) sample scene.
...
#### [Leaderboard Object](../../for-unity-game-engine/scriptable-objects/leaderboard-object.md)
...
#### [Leaderboard Manager](../../for-unity-game-engine/components/leaderboard-manager.md)

You can use the [Leaderboard Manager](../../for-unity-game-engine/components/leaderboard-manager.md) component;\
