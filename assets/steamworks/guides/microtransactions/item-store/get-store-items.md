...
* Item Name\
  You can find this in [item\_name](../../../for-unity-game-engine/scriptable-objects/item-definition.md#item\_name). or by using the [DisplayName](../../../for-unity-game-engine/scriptable-objects/item-definition.md#displayname) field of Item Definition.
* Item Description\
  You can find this in [item\_description](../../../for-unity-game-engine/scriptable-objects/item-definition.md#item\_description).
* Price\
...
* Recipies\
  To detect if this item can be exchanged for and if so what it requires you need to read the [item\_exchange](../../../for-unity-game-engine/scriptable-objects/item-definition.md#item\_exchange).
