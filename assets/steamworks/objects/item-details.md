...
Used by the [Inventory ](../api/inventory.md)interface and in the [Item Definition](../for-unity-game-engine/scriptable-objects/item-definition.md) to represent instances of an item.
