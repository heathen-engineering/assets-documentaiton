...
The most common thing to do with a LobbyMember is to set the [metadata](../troubleshooting-and-how-to-guides/multiplayer/matchmaking-tools.md#metadata) of that member.
...
{% hint style="info" %}
You can learn more about Lobby metadata and LobbyMember metadata by reading [this](../troubleshooting-and-how-to-guides/multiplayer/matchmaking-tools.md#metadata) article.
{% endhint %}
