...
Can be connected to a GameObject along with the [Clan Chat Director](../../unity/components/clan-chat-director.md) to cause the system to automatically join the clan chat on start up.
