...
This event has 1 argument of type [Lobby](../../unity-engine/data-layer/lobby-data.md), being the lobby that was passed in on the command line argument and would have a handler that looks like:
