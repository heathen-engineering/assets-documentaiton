...
This is a scriptable object used to define the leaderboard in Unity and used within Unity to query the board and access its information. Read more in the [Leaderboard Object](../../scriptable-objects/leaderboard-object.md) document.
...
You can learn more about the [Leaderboard Manager](../../components/leaderboard-manager.md) in its documentation article and by reviewing the [4 Leaderboards](../../samples/leaderboards.md) sample scene.
...
#### [Leaderboard Object](../../scriptable-objects/leaderboard-object.md)
