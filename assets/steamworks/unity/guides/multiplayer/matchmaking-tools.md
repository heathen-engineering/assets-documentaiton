...
{% hint style="info" %}
In our example above we used expression to create an anon method. This is a style choice you can learn more about [expression ](broken-reference)and [anon methods](broken-reference) in our other articles.
{% endhint %}
