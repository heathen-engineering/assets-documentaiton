...
The Cursor System component handles cursor state and animation, and should be added to a game object that is initialized with the start of the game and is never destroyed.
