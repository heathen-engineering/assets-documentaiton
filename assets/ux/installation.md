...
\
See why GitHub sponsor is the hands down best way to Do More with Heathen
{% endhint %}
...
Read our [Pacakge Manager Install](../../company/package-manager-install.md) article to get it fixed
