...
This determines the minimal size that the window can be made via the handles. That is a player can not use the handles to make this window smaller than 100 wide and 50 tall.

### Always On Top

![](<../../.gitbook/assets/image (88).png>)

When enabled this causes the window to always be on top no matter what window may have focus at the moment.

### Clamp To Parent

![](<../../.gitbook/assets/image (89).png>)

When enabled this causes the window move and border handles to clamp movement and resize to the boundary of the parent Rect Transform. For example, if you made the parent fill the screen then this window would not allow its self to be dragged outside the bounds of the screen either by movement or resize.

### Focused Event

![](<../../.gitbook/assets/image (90).png>)

Allows the developer to reference a standard [GameEvent](../system-core/game-events.md), this event will be invoked when the window takes focus.

### Evt Focused

![](<../../.gitbook/assets/image (91).png>)

A simple Unity Event similar to the Click event on a Button, this event will be invoked when the window takes focus.
