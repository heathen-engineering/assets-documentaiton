...
As such you are advised to put your system level objects in a bootstrap scene which should be on build index 0 and only ever loaded once, this whether or not you use Do Not Destroy On Load.
