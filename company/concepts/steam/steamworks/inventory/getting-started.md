...
{% hint style="info" %}
The Inventory Item Definitions stored in your Steam Settings object act as an inventory. See the [Inventory Item](../../../../../assets/steamworks/unity-engine/scriptable-objects/item-definition.md) documentation for more information.
{% endhint %}
