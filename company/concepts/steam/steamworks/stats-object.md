...
See the [Int Stat Object](../../../../assets/steamworks/unity-engine/scriptable-objects/int-stat.md), [Float Stat Object](../../../../assets/steamworks/unity-engine/scriptable-objects/float-stat.md) and [Avg Rate Stat Object](../../../../assets/steamworks/unity-engine/scriptable-objects/avg-rate-stat.md) for details on how to use each. In general though the process is that you will create a reference to the stat in question in one of your game's scripts such as
