...
First, understand that not every game needs achievements, that if your going to have achievements they should be part of the game and not an afterthought you bolted on because why not. Meaningless achievements can harm the user experience by breaking immersion or simply drawing attention away during gameplay.
...
>
> Steam Stats and Achievements provide an easy way for your game to provide persistent, roaming achievement and statistics tracking for your users. The user's data is associated with their Steam account, and each user's achievements and statistics can be formatted and displayed in their Steam Community Profile.
...
Valve's documentation on the [Stats and Achievement](https://partner.steamgames.com/doc/features/achievements) features are a good place to get started.
