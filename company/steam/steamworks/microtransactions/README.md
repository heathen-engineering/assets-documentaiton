...
The [Steam Inventory](../inventory/) system can be used for several things not just MTX. If you are interested in using Steam for MTX then it is [Steam Inventory](../inventory/) that you will be using to define your items, establish their prices, start purchases and detect what items the user owns.
