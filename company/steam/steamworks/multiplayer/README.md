...
A feature of Steam's Lobby system. SetGameServer is a method available to you on the [Lobby](../../../../toolkit-for-steamworks-sdk/unity/classes-and-structs/lobby-data.md) and through the [Matchmaking ](../../../../toolkit-for-steamworks-sdk/unity/api/matchmaking.client.md)API. Only the owner of the lobby can call this method.
