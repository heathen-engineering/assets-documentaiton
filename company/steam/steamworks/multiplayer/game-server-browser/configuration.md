...
If you're working in C# and not using scriptable objects at all you can create a [SteamGameServerConfiguraiton ](../../../../../heathens-steamworks-complete/unity/objects/steam-game-server-configuration.md)and pass that to the [API.App.Server.Initialization(...)](../../../../../heathens-steamworks-complete/unity/api/app.server.md#initialize) method.
