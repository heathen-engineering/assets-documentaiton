...
If you're working in C# and not using scriptable objects at all you can create a [SteamGameServerConfiguraiton ](../../../../../old-toolkit-for-steamworks/unity/objects/classes/steam-game-server-configuration.md)and pass that to the [API.App.Server.Initialization(...)](../../../../../old-toolkit-for-steamworks/unity/api-extensions/app.server.md#initialize) method.
