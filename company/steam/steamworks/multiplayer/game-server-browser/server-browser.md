...
The [Game Server Browser Manager](../../../../../toolkit-for-steamworks-sdk/unity/components/game-server-browser-manager.md) is a Unity component we designed to simplify the query of the Steam Game Server browser entries. Our browser manager works with the [Matchmaking.Client API](../../../../../toolkit-for-steamworks-sdk/unity/api/matchmaking.client.md) to query Steam for lists of servers.
