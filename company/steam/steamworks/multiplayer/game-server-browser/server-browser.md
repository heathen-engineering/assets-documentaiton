...
{% hint style="info" %}
Heathen's Steamworks Complete for Unity trivializes all of this, the [Steam Settings](../../../../../heathens-steamworks-complete/unity/scriptable-objects/steam-settings/) scriptable object contains all the configuration options so you can set them in the Unity inspector.&#x20;
...
The [Game Server Browser Manager](../../../../../heathens-steamworks-complete/unity/components/game-server-browser-manager.md) is a Unity component we designed to simplify the query of the Steam Game Server browser entries. Our browser manager works with the [Matchmaking.Client API](../../../../../heathens-steamworks-complete/unity/api/matchmaking.client.md) to query Steam for lists of servers.
