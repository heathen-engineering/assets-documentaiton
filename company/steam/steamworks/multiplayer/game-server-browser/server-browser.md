...
{% hint style="info" %}
Heathen's Steamworks Complete for Unity trivializes all of this, the [Steam Settings](../../../../../heathens-toolkit-for-steamworks-sdk/unity/scriptable-objects/steam-settings/) scriptable object contains all the configuration options so you can set them in the Unity inspector.&#x20;
...
The [Game Server Browser Manager](../../../../../heathens-toolkit-for-steamworks-sdk/unity/components/game-server-browser-manager.md) is a Unity component we designed to simplify the query of the Steam Game Server browser entries. Our browser manager works with the [Matchmaking.Client API](../../../../../heathens-toolkit-for-steamworks-sdk/unity/api/matchmaking.client.md) to query Steam for lists of servers.
