...
See the [Int Stat Object](../../../heathens-toolkit-for-steamworks-sdk/unity/scriptable-objects/int-stat.md), [Float Stat Object](../../../heathens-toolkit-for-steamworks-sdk/unity/scriptable-objects/float-stat.md) and [Avg Rate Stat Object](../../../heathens-toolkit-for-steamworks-sdk/unity/scriptable-objects/avg-rate-stat.md) for details on how to use each. In general though the process is that you will create a reference to the stat in question in one of your game's scripts such as
