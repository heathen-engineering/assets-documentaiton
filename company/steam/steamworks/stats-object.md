...
See the [Int Stat Object](../../../toolkit-for-steamworks-sdk/unity/classes-and-structs/int-stat.md), [Float Stat Object](../../../toolkit-for-steamworks-sdk/unity/classes-and-structs/float-stat.md) and [Avg Rate Stat Object](../../../toolkit-for-steamworks-sdk/unity/classes-and-structs/avg-rate-stat.md) for details on how to use each. In general though the process is that you will create a reference to the stat in question in one of your game's scripts such as
