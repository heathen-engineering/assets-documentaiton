...
This scene exists to draw your attention to the [User Data](../data-layer/user-data.md) object. User Data is a struct Heathen has defined to wrap around the native [CSteamID ](../../../steam/csteamid/)and the primitive ulong data types providing easy access to everything user related.
