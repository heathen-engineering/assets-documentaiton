...
Importantly you should understand that any "Online Subsystem" is an attempt at shoehorning a given platform's features into the form expected by the Online Subsystem Framework. This means you cannot take full advantage of the platform, you cannot leverage all the features available and you must use the limited integration in the Unreal-defined manner, in the case of Steam API this is hugely limiting and greatly reduces the value of Steam API which is a rather large, expansive and incredibly feature reach SDK.
