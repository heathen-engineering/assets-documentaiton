...
{% hint style="info" %}
Its generally easier to use the [Clan Chat Director](../objects/ui-components/clan-chat-director.md) than to manually listen on this event.
{% endhint %}
...
You can learn more about [ClanChatMsg](../objects/classes/clan-chat-msg.md) in its article.
...
You generally do not need to call this if your using the [EventChatMessageReceievd ](clans.client.md#eventchatmessagerecieved)or the [ClanChatDirector](../objects/ui-components/clan-chat-director.md).
