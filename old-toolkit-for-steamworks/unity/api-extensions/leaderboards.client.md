...
{% hint style="success" %}
The [Leaderboard ](../objects/classes/leaderboard-object.md)object provides simplified access to many of the features found here in. Be sure to read the documentation for the [Leaderboard ](../objects/classes/leaderboard-object.md)object to understand what options are available to you.
{% endhint %}
