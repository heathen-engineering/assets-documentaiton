...
Returned as a result of the [API.Input.Client.Update(...)](../../api-extensions/input.client.md#update) method this contains all the current action data and report of changes since the last update was ran for a specific controller.
