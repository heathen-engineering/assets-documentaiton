...
Automatically handles the creation and exit of a group lobby. You can always fetch the current group lobby from the [Lobby ](../classes/lobby-data.md)structure.
