...
Gets the [Lobby Member](../classes/lobby-member-data.md) data for the current lobby owner.
...
Gets the local user's [Lobby Member](../classes/lobby-member-data.md) data for the current lobby.
