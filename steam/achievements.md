...
[API](../toolkit-for-steamworks-sdk/unity/api/statsandachievements.client.md)

Heathen's Steamworks wraps Valve's Steam API with a C# and Unity-friendly tool kit. All features related to stats and achievements can be found in the [StatsAndAchievements.Client](../toolkit-for-steamworks-sdk/unity/api/statsandachievements.client.md) class. In most cases, you won't need to use this low-level tool but it is available to you and works very similar to the raw Steam API.
