...
Heathen has tools and guidance to help you with this process. Please read the [Item Definition Tools article](inventory/item-definition-tools.md) for more information.
...
* &#x20;Get references to the specific items that will be exchanged\
  ...
  * [Item Data Get Exchange Entry](../assets/steamworks/data-layer/item-data.md#get-exchange-entry)
  * [Inventory API Get Exchange Entry](../assets/steamworks/api/inventory.md#exchange-items)
* On the item you wish to "craft" exchange the reagents you just collected\
  ...
  * [Item Data Exchange](../assets/steamworks/data-layer/item-data.md#exchange)
  * [Inventory API Exchange](../assets/steamworks/api/inventory.md#exchange-items)
...
The [Item Definition Tools](inventory/item-definition-tools.md) provided by Setamworks Complete can assist you in creating properly formatted recipes for your items.
