...
{% hint style="info" %}
The Inventory Item Definitions stored in your Steam Settings object act as an inventory. See the [Inventory Item](../../toolkit-for-steamworks/unity/classes-and-structs/item-definition.md) documentation for more information.
{% endhint %}
