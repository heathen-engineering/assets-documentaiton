...
{% hint style="info" %}
Callbacks are a common feature of many multi-process systems including Unity itself.  You can [learn more about them here](../../guides/development/callbacks.md).
{% endhint %}
