...
## [Workshop Item Data](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md)

This is a simple `struct` we created that lets you gather up all of the inputs needed to create a new workshop item. You can find details on the [Workshop Item Data](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md) object in its article. Here is a list of data you will need in order to create a [Workshop Item Data](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md) object.

* **App ID**\
  This will nearly always be your game's App ID and is the ID of the app this item is made to work with. You can read this from our API easily via [App.Client.Id](../../assets/steamworks/unity-engine/api/app.client.md#id).
* **Title**\
...
To create the item simply instantiate a new [WorkshopItemData ](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md)object
...
2. Set the required values on that new empty "file id"\
   This is where we set and update the file id created in step 1 with all the data you gave us in the [Workshop Item Data](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md) object.

Nearly 100% of the time the issue is with the data you provided to the [Workshop Item Data](../../assets/steamworks/unity-engine/data-layer/workshop-item-data.md) object. The most common issues are listed below
