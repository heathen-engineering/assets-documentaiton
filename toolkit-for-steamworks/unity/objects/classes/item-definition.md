...
This can only be used if you have called [LoadItemDefintions](../../api-extensions/inventory.client.md#loaditemdefinitions) from the [Inventory API](../../api-extensions/inventory.client.md#introduction). It returns the localized name of the item if any.
...
Gets the simple description as defined in your schema. If you need the langauge based name you will need to fetch [item defintions](../../api-extensions/inventory.client.md#loaditemdefinitions) and [get the description property](../../api-extensions/inventory.client.md#getitemdefinitionproperty).
...
Gets the simple display type as defined in your schema. If you need the langauge based name you will need to fetch [item defintions](../../api-extensions/inventory.client.md#loaditemdefinitions) and [get the description property](../../api-extensions/inventory.client.md#getitemdefinitionproperty).
